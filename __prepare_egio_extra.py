...
#gtf = "/Users/jeffma/MJFPhD/EGIOdb/step0_GEIO_script_dbversion/EGIO-main/hsa/hsa.gtf"
#cdna = "/Users/jeffma/MJFPhD/EGIOdb/step0_GEIO_script_dbversion/EGIO-main/hsa/hsa_mRNA.fa"
#cds = "/Users/jeffma/MJFPhD/EGIOdb/step0_GEIO_script_dbversion/EGIO-main/hsa/hsa_CDS.fa"
#species="hsa"
def prepare_geio_extra(gtf, cdna, cds, species):
    ...
    tran_name = []
    tran_cdna = []
    tf = open(str(cdna),encoding = 'utf8')
    line = tf.readline()
    transnum = 0
    seq = ''
    while line:
